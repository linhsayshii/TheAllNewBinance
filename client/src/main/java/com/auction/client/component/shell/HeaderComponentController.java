...
public class HeaderComponentController {
    ...
    @FXML private FontIcon themeModeIcon;

    @FXML private javafx.scene.layout.HBox guestContainer;

    @FXML private javafx.scene.layout.HBox authContainer;

    @FXML private javafx.scene.control.Hyperlink usernameLink;
    ...
    private void initialize() {
        ...
        com.auction.client.service.UserSessionService.getInstance()
                .currentUserProperty()
                .addListener(new WeakChangeListener<>(authChangeListener));
    }
    ...
    private void refreshAuthState() {
        if (guestContainer == null || authContainer == null) {
            return;
        }
        ...
        if (isAuthenticated && usernameLink != null) {
            com.auction.core.users.User user =
                    com.auction.client.service.UserSessionService.getInstance().getCurrentUser();
    ...
    private void handleGoToProfile() {
        ...
        if (user != null && user.getId() != null) {
            NavigationService.getInstance()
                    .navigateTo(
                            SceneRegistry.PROFILE_PAGE, java.util.Map.of("userId", user.getId()));
        } else {
