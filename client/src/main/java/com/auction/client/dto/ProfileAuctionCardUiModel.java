...
/**
 * UI model for the compact ProfileAuctionCard component used in the
 * User Profile page (My Bids, My Listings, and Public Seller View sections).
 *
 * Unlike {@link ProductCardUiModel} which is designed for the wide carousel
 * cards on the General page, this record is tuned for compact profile cards:
 * — no progress bar
 * — status badge with human-readable label and CSS style class
 * — priceCaption changes depending on context ("Current bid" vs "Final price")
 */
public record ProfileAuctionCardUiModel(
    ...
    public static ProfileAuctionCardUiModel winning(
        ...
        return new ProfileAuctionCardUiModel(
                auctionId, title, "Current bid", price, timeInfo, "WINNING", "badge-winning", false, null);
    }
    ...
    public static ProfileAuctionCardUiModel outbid(
            Integer auctionId, String title, String price, String timeInfo) {
        return new ProfileAuctionCardUiModel(
                auctionId, title, "Current bid", price, timeInfo, "OUTBID", "badge-outbid", false, null);
    }
    ...
    public static ProfileAuctionCardUiModel won(
        ...
        return new ProfileAuctionCardUiModel(
                auctionId, title, "Final price", finalPrice, endedInfo, "WON", "badge-won", false, null);
    }
    ...
    public static ProfileAuctionCardUiModel live(
        ...
        return new ProfileAuctionCardUiModel(
                auctionId, title, "Current bid", price, timeInfo, "LIVE", "badge-live", isFeatured, null);
    }
    ...
    public static ProfileAuctionCardUiModel pending(
        ...
        return new ProfileAuctionCardUiModel(
                auctionId, title, "Opening bid", price, startInfo, "PENDING", "badge-pending", false, null);
    }
    ...
    public static ProfileAuctionCardUiModel sold(
            Integer auctionId, String title, String finalPrice, String endedInfo) {
        return new ProfileAuctionCardUiModel(
                auctionId, title, "Final price", finalPrice, endedInfo, "SOLD", "badge-sold", false, null);
    }
    ...
    public static ProfileAuctionCardUiModel unsold(
        ...
        return new ProfileAuctionCardUiModel(
                auctionId, title, "Opening bid", price, endedInfo, "UNSOLD", "badge-unsold", false, null);
    }
}
