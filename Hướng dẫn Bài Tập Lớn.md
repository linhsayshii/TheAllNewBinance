# [cite_start]Hướng dẫn Bài tập lớn LTNC 2026 [cite: 1, 2]
...
* [cite_start]Bây giờ là Tuần 6. Tuần 15 các nhóm sẽ trình bày và chấm điểm. [cite: 7]
...
Bài giảng tuần này: Mẫu thiết kế và nguyên lý thiết kế. [cite_start]Công việc cụ thể: [cite: 42]
...
* [cite_start]Design Patterns: https://www.youtube.com/watch?v=mE3qTp1TEbg&list=PLlsmxlJgn1HJpa28yHzkBmUY-Ty71ZUGC [cite: 51, 52, 53, 54]
* [cite_start]Refactoring Guru: https://refactoring.guru/design-patterns [cite: 55]
* [cite_start]JavaFX - Học theo thứ tự sau: [cite: 56]
  1. [cite_start]Cài đặt JavaFX: https://openjfx.io/openjfx-docs/ [cite: 57]
  2. [cite_start]Video setup IntelliJ: https://www.youtube.com/watch?v=Ope4icw6bVk [cite: 58]
  3. [cite_start]Playlist cơ bản (các component): https://www.youtube.com/watch?v=_70M-CMYWbQ&list=PLZPZq0r_RZOM-8vJA3NQFZB7JroDcMwev [cite: 59]
  4. [cite_start]Setup SceneBuilder + IntelliJ: https://www.youtube.com/watch?v=IZCwawKILsk [cite: 60]
  5. [cite_start]Controller trong SceneBuilder: https://www.youtube.com/watch?v=OwQ68q7PD9w&list=PLfu_Bpi_zcDNYL61710p3S1ABtuyFV7Nr&index=16 [cite: 61]

### [cite_start]Tuần 7 – Đa luồng, Observer & Phát triển GUI [cite: 64]
Bài giảng tuần này: Lập trình đa luồng và song song. [cite_start]Công việc cụ thể: [cite: 65]
...
* [cite_start]Race Conditions: https://www.youtube.com/watch?v=RMR75VzYoos [cite: 76, 77, 78, 79]

### [cite_start]Tuần 8 – Kiểm thử, Ngoại lệ & GUI nâng cao [cite: 80]
Bài giảng tuần này: Kiểm thử và Tái cấu trúc mã nguồn. [cite_start]Công việc cụ thể: [cite: 81]
1. [cite_start]Tạo custom exceptions: Invalid BidException, AuctionClosedException, AuthenticationException. [cite: 82]
...
* [cite_start]JUnit 5 User Guide: https://docs.junit.org/5.5.0/user-guide/ [cite: 89, 90]
* [cite_start]MVC trong JavaFX: [cite: 91]
  * [cite_start]Repo mẫu MVC: https://github.com/ZacharyDavidSaunders/Inventory_Management_System [cite: 92]
  * [cite_start]Tài liệu MVC: https://www.pragmaticcoding.ca/javafx/MVC_In_JavaFX [cite: 93]
  * [cite_start]Video MVC: https://www.youtube.com/watch?v=Mu3VNzwpFII [cite: 94]

### [cite_start]Tuần 9 – Tích hợp, CI/CD & Lập trình mạng [cite: 97]
Bài giảng tuần này: Tích hợp và triển khai. [cite_start]Công việc cụ thể: [cite: 98]
...
* [cite_start]CI/CD: https://www.youtube.com/watch?v=UTb3nNbH7M4 [cite: 105, 106]
* [cite_start]Checkstyle + Maven: https://medium.com/@sruthiganesh/integrating-checkstyle-in-java-projects-with-maven-b1ac2cafd016 [cite: 107]
* [cite_start]Serialization: https://www.youtube.com/watch?v=DfbFTVNfkeI [cite: 108]
* [cite_start]Serialization: https://www.geeksforgeeks.org/java/serialization-and-deserialization-in-java/ [cite: 109, 110, 111]
* [cite_start]Lập trình mạng Học theo thứ tự: [cite: 114]
  1. [cite_start]Cơ bản Socket: https://www.youtube.com/watch?v=plh_cIEQ1Jo [cite: 115]
  2. [cite_start]Tài liệu Baeldung: https://www.baeldung.com/a-guide-to-java-sockets [cite: 112, 113, 116, 120]
  3. [cite_start]Gửi Serialized Objects: https://www.youtube.com/watch?v=lup-oHjCcis [cite: 117, 118, 121]
  4. [cite_start]App nhắn tin realtime (JavaFX + Socket): https://www.youtube.com/watch?v=_1nqY-DKP9A [cite: 119]

### [cite_start]Tuần 10 Hướng dẫn tự học nâng cao & Ôn tập (Buổi giảng cuối) [cite: 122, 123]
Bài giảng tuần này: Hướng dẫn tự học các nội dung nâng cao và Ôn tập. [cite_start]Công việc cụ thể: [cite: 124]
...
Không còn bài giảng - tập trung hoàn toàn vào dự án. [cite_start]Công việc cụ thể: [cite: 135]
...
* [cite_start]Realtime LineChart: https://www.youtube.com/watch?v=HWfZPiPulsI [cite: 152, 153, 154]
...
## [cite_start]Bảng tổng hợp lộ trình [cite: 162]

| Tuần | Bài giảng trên lớp | Việc cần làm cho BTL | Tự học |
|---|---|---|---|
| 6 | Mẫu thiết kế & Nguyên lý thiết kế | Khởi tạo dự án, thiết kế OOP, Singleton, Factory | [cite_start]JavaFX + SceneBuilder | [cite: 163]
| 7 | Đa luồng & Song song | Observer, logic đấu giá, concurrency | [cite_start]JavaFX màn hình cơ bản | [cite: 163]
| 8 | Kiểm thử & Tái cấu trúc | Custom exceptions, JUnit, refactor SOLID | [cite_start]MVC trong JavaFX | [cite: 163]
| 9 | Tích hợp & Triển khai | Maven, Checkstyle, GitHub Actions | [cite_start]Socket, Serialization | [cite: 163]
| 10 | Hướng dẫn tự học & Ôn tập (buổi cuối) | Client-Server, hoàn thiện GUI | [cite_start]Networking, lưu trữ | [cite: 163]
| 11-12 | Không còn bài giảng | Tích hợp toàn bộ, e2e testing, fix bugs | [cite_start]Tổng hợp | [cite: 163]
| 13-14 | Không còn bài giảng | Polish UI, chức năng nâng cao | [cite_start]Tổng hợp | [cite: 166]
| 15 | Trình bày | Demo & Chấm điểm | [cite_start]| [cite: 166]

## [cite_start]Dự án tham khảo trên GitHub [cite: 167]
1. [cite_start]Auction System (Multi-client, JavaFX): https://github.com/nlintas/Auction-System-in-Java [cite: 168, 169]
2. [cite_start]Socket Auction (Kotlin + JavaFX): https://github.com/gangulwar/socket-programming-auction-system [cite: 170, 171]
3. [cite_start]Auction + MySQL Database: https://github.com/Prasanna-icefire/AuctionSystem [cite: 172, 173]
4. [cite_start]Auction + Google Gson + Azure: https://github.com/AqibMughal1/Auction-System-JavaFX [cite: 174, 175]

## [cite_start]Thang điểm tóm tắt [cite: 176]

| Nội dung | Điểm | Mức |
|---|---|---|
| Thiết kế lớp và cây kế thừa | 0.5 | [cite_start]Bắt buộc | [cite: 177]
| Áp dụng OOP (Encapsulation, Inheritance, Polymorphism, Abstraction) | 1.0 | [cite_start]Bắt buộc | [cite: 177]
| Design Patterns phù hợp | 1.0 | [cite_start]Bắt buộc | [cite: 177]
| Quản lý người dùng, sản phẩm | 1.0 | [cite_start]Bắt buộc | [cite: 177]
| Chức năng đấu giá | 1.0 | [cite_start]Bắt buộc | [cite: 177]
| Xử lý lỗi & ngoại lệ | 1.0 | [cite_start]Bắt buộc | [cite: 177]
| Xử lý đấu giá đồng thời (concurrency) | 1.0 | [cite_start]Bắt buộc | [cite: 177]
| Realtime update (Observer/Socket) | 0.5 | [cite_start]Bắt buộc | [cite: 177]
| Kiến trúc Client-Server | 0.5 | [cite_start]Bắt buộc | [cite: 177]
| MVC (JavaFX, FXML, Controller-Model-DAO) | 0.5 | [cite_start]Bắt buộc | [cite: 177]
| Maven/Gradle, coding convention | 0.5 | [cite_start]Bắt buộc | [cite: 177]
| Unit Test (JUnit) | 0.5 | [cite_start]Bắt buộc | [cite: 177]
| CI/CD (GitHub Actions) | 0.5 | [cite_start]Bắt buộc | [cite: 177]
| Auto-Bidding | 0.5 | [cite_start]Tuỳ chọn | [cite: 177]
| Anti-sniping | 0.5 | [cite_start]Tuỳ chọn | [cite: 177]
| Bid History Visualization | 0.5 | [cite_start]Tuỳ chọn | [cite: 177]
| Tổng | 10+1.5 | [cite_start]| [cite: 177]

## [cite_start]Lời khuyên [cite: 180]
[cite_start]**Mẹo** [cite: 181]
...
[cite_start]Ba nội dung JavaFX, Lập trình mạng (Socket) và Lưu trữ dữ liệu (Serialization) đều không được dạy trên lớp nhưng là yêu cầu bắt buộc của bài tập lớn. [cite: 190]
[cite_start]Hãy chủ động tự học ngay từ bây giờ. [cite: 191]
