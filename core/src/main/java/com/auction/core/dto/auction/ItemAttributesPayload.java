 ...
 * com.auction.core.dto.auction.serialization.ItemAttributesPayloadSerializer} to enable
 * Gson Polymorphic Deserialization at the Socket boundary without {@code ClassCastException} risk.
 */
