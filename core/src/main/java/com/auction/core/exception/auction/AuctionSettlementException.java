...
/**
 * Thrown when the scheduler fails to settle an auction that is not in ACTIVE status, ensuring the
 * settlement task never runs on auctions in incorrect states.
 */
