...
/**
 * Thrown when the scheduler fails to transition an auction from PENDING to ACTIVE,
 * either because the auction is not in PENDING status or the DB update failed.
 */
