...
/**
 * Factory chịu trách nhiệm tái nạp (Rehydration) và khởi tạo thực thể User. Do nằm cùng package
 * 'com.auction.core.users', Factory có đặc quyền truy cập constructor package-private của các lớp
 * con để đảm bảo tính đóng gói đối với bên ngoài.
 */
public final class UserFactory {
    ...
    /**
     * Tái lập thực thể User từ Database (Rehydration). Sử dụng Switch Expression của Java 21 với
     * Exhaustiveness check để đảm bảo an toàn mở rộng.
     *
    ...
    /**
     * Chuyển đổi thực thể Domain User sang DTO an toàn (UserDto) để truyền qua Socket. Kích hoạt
     * Dynamic Dispatch tại Server Node để nhúng kết quả đa hình vào DTO phẳng, triệt tiêu hoàn toàn
     * logic phân rã chuỗi Role cứng ở phía Client JavaFX.
     *
