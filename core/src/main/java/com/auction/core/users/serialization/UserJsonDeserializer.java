    ...
    public User deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
        ...
        String username =
                obj.has("username") && !obj.get("username").isJsonNull()
                        ...
                        : "";
        String roleStr =
                obj.has("role") && !obj.get("role").isJsonNull()
        ...
        String password =
                obj.has("password") && !obj.get("password").isJsonNull()
                        ...
                        : "";
        String fullName =
                obj.has("fullName") && !obj.get("fullName").isJsonNull()
                        ? obj.get("fullName").getAsString()
                        : "";
        String email =
                obj.has("email") && !obj.get("email").isJsonNull()
                        ? obj.get("email").getAsString()
                        : "";
        Boolean isActive =
                obj.has("isActive") && !obj.get("isActive").isJsonNull()
                        ? obj.get("isActive").getAsBoolean()
                        : true;

        BigDecimal balance =
                obj.has("balance") && !obj.get("balance").isJsonNull()
                        ? obj.get("balance").getAsBigDecimal()
                        : BigDecimal.ZERO;
        BigDecimal lockedBalance =
                obj.has("lockedBalance") && !obj.get("lockedBalance").isJsonNull()
                        ? obj.get("lockedBalance").getAsBigDecimal()
                        : BigDecimal.ZERO;
