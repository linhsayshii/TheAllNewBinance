...
public interface IAuctionService {
    ...
    CompletableFuture<com.auction.core.dto.auction.AuctionDetailsDto> getAuctionDetails(Integer auctionId);
    ...
    CompletableFuture<List<PublicAuctionDto>> getPublicAuctions(com.auction.core.dto.auction.GetPublicAuctionsRequest request);
    ...
    CompletableFuture<List<PublicAuctionDto>> getFeaturedAuctions(GetFeaturedAuctionsRequest request);

    /** Admin: Lấy tất cả auctions theo status (cho trang Listing Management). */
    CompletableFuture<List<PublicAuctionDto>> getAllAuctionsForAdmin(String status, int page, int size);
}