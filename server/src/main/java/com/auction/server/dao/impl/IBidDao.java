...
public interface IBidDao {
    ...
    /**
     * Lưu Bid dùng chung Connection của Transaction đang hoạt động.
    ...
    /**
     * Lấy danh sách Bid dùng chung Connection của Transaction đang hoạt động.
     * Đảm bảo Repeatable Read nhất quán, tránh Phantom Read với Late Bids giây cuối.
     */
    ...
    /**
     * Kiểm tra Bid dùng chung Connection của Transaction đang hoạt động.
     * Tránh race condition đặt cọc khi nhiều thầu đến cùng lúc.
     */
