...
/**
 * Wraps a validated bid request with its result future.
 * Submitted to BidQueueManager for serial processing per auction.
 */
public class BidTask {
    ...
    public BidTask(PlaceBid request,
    ...
    public PlaceBid getRequest() { return request; }
    public CompletableFuture<Bid> getResultFuture() { return resultFuture; }
    public com.auction.core.auction.Auction getSnapshot() { return snapshot; }
    public boolean isFirstBid() { return firstBid; }
}
